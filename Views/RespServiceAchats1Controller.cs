...
namespace GAP.Views
{
    public class RespServiceAchats1Controller : Controller
    {
        private readonly GAPContext _context;

        public RespServiceAchats1Controller(GAPContext context)
        {
            _context = context;
        }

        // GET: RespServiceAchats1
        ...
        // GET: RespServiceAchats1/Details/5
        ...
        // GET: RespServiceAchats1/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: RespServiceAchats1/Create
        ...
        // POST: RespServiceAchats1/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: RespServiceAchats1/Delete/5
        ...
        // POST: RespServiceAchats1/Delete/5
