...
namespace GAP.Views
{
    public class ReceptServiceAchatsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserID,Email,Password,FirstName,LastName,Tutulaire")] ReceptServiceAchat receptServiceAchat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserID,Email,Password,FirstName,LastName,Tutulaire")] ReceptServiceAchat receptServiceAchat)
        {
