...
namespace GAP.Views
{
    public class RespServiceAchatsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserID,Email,Password,FirstName,LastName,Tutulaire")] RespServiceAchat respServiceAchat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserID,Email,Password,FirstName,LastName,Tutulaire")] RespServiceAchat respServiceAchat)
        {
