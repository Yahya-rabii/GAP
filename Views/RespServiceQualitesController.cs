...
namespace GAP.Views
{
    public class RespServiceQualitesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserID,Email,Password,FirstName,LastName,Tutulaire")] RespServiceQualite respServiceQualite)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserID,Email,Password,FirstName,LastName,Tutulaire")] RespServiceQualite respServiceQualite)
        {
